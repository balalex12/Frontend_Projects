            ...
            <div class="card-body">
                <form v-on:submit.prevent="actualizarRegistro">
                    <div class="form-group">
                      ...
                      <small id="helpId" class="form-text text-muted">Escribrir nombre del empleado.</small>
                    </div>    
                    ...
                    <div class="form-group">
                      ...
                      <small id="helpId" class="form-text text-muted">Insertar correo del empleado.</small>
                    </div>
...
export default {
    ...
    methods:{           
            ...
            actualizarRegistro(){
                ...
                fetch('http://localhost/empleados/?actualizar='+this.$route.params.id, {method:"POST", body:JSON.stringify(datosEnviar)})
                .then(respuesta=>respuesta.json())
                .then(datosRespuesta=>{
                    console.log(datosRespuesta);
